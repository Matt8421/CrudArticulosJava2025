...
public class Ejercicios {
    ...
    public static void main(String[] args) {
        ...
        //Tipo de dato del objeto  nombre = new(palabra reservada p/ instanciar un objeto en memoria) constructor de la clase con los parametros que recibe para crear ese objeto en memoria.
        ...
        // Imprimimos las variables
        System.out.println("Primitivo: " + primitivoD);
        System.out.println("Envolvente: " + envolventeD);
        System.out.println("Autoboxing: " + autoboxingD);
        System.out.println("Unboxing: " + unboxingD);
        ...
        // Imprimimos las variables
        System.out.println("Primitivo: " + primitivoC);
        System.out.println("Envolvente: " + envolventeC);
        System.out.println("Autoboxing: " + autoboxingC);
        System.out.println("Unboxing: " + unboxingC);
        ...
        // Imprimimos las variables
        System.out.println("Primitivo: " + primitivoB);
        System.out.println("Envolvente: " + envolventeB);
        System.out.println("Autoboxing: " + autoboxingB);
        System.out.println("Unboxing: " + unboxingB);
        ...
        */
            System.out.println(nombre3 == otroNombre3); // false
            System.out.println(nombre3.equals(otroNombre3)); // false
